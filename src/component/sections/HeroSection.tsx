    ...
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden pt-24 pb-32">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto text-center mt-40 md:mt-0">
          <h1 className="text-[3rem] md:text-[4rem] lg:text-[5rem] xl:text-[6rem] font-bold mb-6 bg-clip-text text-white" style={{fontFamily: 'Montserrat-LightItalic'}}>No-code </h1>
          <h1 className="text-[3rem] md:text-[4rem] lg:text-[5rem] xl:text-[6rem] font-bold mb-6 bg-clip-text text-white " style={{fontFamily: 'Montserrat-LightItalic'}}>
            <span className="text-white" style={{ textShadow: '0 0 10px white, 0 0 40px yellow, 0 0 30px orange' }}>AI agents </span> for DeFi
          </h1>
